  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "Идея этой заметки - показать, как проявляется проблема, почему она быстро выдает генеративную картинку и какими костыльными способами ее можно сгладить."
      ]
    },
    {
      id: "problem",
      ...
      paragraphs: [
        "ChatGPT Imagen 2.0 - относительно новая генеративная модель. Она делает сильные фотореалистичные изображения, поэтому ее активно используют в проектах. У модели есть три режима качества: low, medium и high. Похожие артефакты иногда встречаются и в Nano Banana Pro, но в этом эксперименте я смотрю именно на Imagen 2.0.",
        "О чем речь: при генерации людей на волосах, а иногда и на коже, появляются характерные AI-артефакты, которые быстро выдают генеративную картинку. На волосах это выглядит как гофре, заломы или повторяющиеся волны по длине, хотя в промпте такой укладки нет. Кожа может уходить в пятна и становиться менее естественной.",
        "**Читала теорию**, что после маркировки сгенерированного звука и видео могут появляться аналогичные невидимые водяные знаки для изображений. Возможно, в фотографиях это проявляется иначе, и я не утверждаю, что конкретно эти артефакты связаны с маркировкой. Но гипотеза объясняет, почему часть дефектов выглядит не как обычная ошибка генерации, а как повторяющийся паттерн."
      ]
    },
    {
      id: "experiment",
