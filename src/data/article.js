...
const articlePart3 = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "ChatGPT Imagen 2.0 - относительно новая генеративная модель. Она делает сильные фотореалистичные изображения, поэтому ее активно используют в проектах. У модели есть три режима качества: low, medium и high.",
