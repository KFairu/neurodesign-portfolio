...
const links = [
  ["top-input-1-out", "topview-model-image-a-in", "green"],
  ["top-input-2-out", "topview-model-image-b-in", "green"],
  ["topview-extra-image-out", "topview-model-image-c-in", "green"],
  ["topview-prompt-out", "topview-model-prompt-in", "purple"],
];
