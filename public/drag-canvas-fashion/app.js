...
const links = [
  ["image-base-out", "gemini-image-a-in", "green"],
  ["image-room-a-out", "gemini-image-b-in", "green"],
  ["image-room-b-out", "gemini-image-c-in", "green"],
  ["prompt-fashion-out", "gemini-prompt-in", "purple"],
  ["image-base-out", "imagen-image-a-in", "green"],
  ["image-room-a-out", "imagen-image-b-in", "green"],
  ["image-room-b-out", "imagen-image-c-in", "green"],
  ["prompt-fashion-out", "imagen-prompt-in", "purple"],
];

let topLayer = 20;
let activeDragNode = null;
const defaultCanvasScale = parseFloat(getComputedStyle(document.documentElement).getPropertyValue("--canvas-scale")) || 0.42;
