...
const links = [
  ["angle-input-1-out", "angle-model-image-a-in", "green"],
  ["angle-input-2-out", "angle-model-image-b-in", "green"],
  ["angle-panorama-out", "angle-model-image-c-in", "green"],
  ["angle-topview-out", "angle-model-image-d-in", "green"],
  ["angle-prompt-out", "angle-model-prompt-in", "purple"],
];
...
workspace.addEventListener("pointerdown", () => workspace.focus({ preventScroll: true }));
...
workspace.addEventListener("scroll", requestRenderConnections, { passive: true });
renderConnections();
